...
import 'package:shop_sallh/MyBlocObserver.dart';
...
import 'package:shop_sallh/maduels/onBrading/onBoarding.dart';
...
import 'package:shop_sallh/shared/style/style.dart';
...
void main() async {
  ...
  bool? onBording = CachHelper.getdate(key: 'onBarding');
 ...
 final Widget widget;
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create:(context) => AppShopCubit()..gethomedata()..getcatagorydata()..FavoriteData()..getSettinges(),),
        BlocProvider(create: (context) => AppSerachCubit(),)
      ],
